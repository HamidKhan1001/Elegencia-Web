...
const products = [
  { name: "Single Bottle", subtitle: "500ml · The Flagship", tag: "Flagship", tagColor: "#4a9eca", features: ["500ml glacial water", "Sky-blue cap", "Gift sleeve"], qty: "", img: withBasePath("/products/bottle-500ml-front.png") },
