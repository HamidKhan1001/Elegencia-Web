...
const products = [
  { name: "Single Bottle", subtitle: "500ml · The Flagship", tag: "Flagship", tagColor: "#4a9eca", features: ["500ml glacial water", "Sky-blue cap", "Gift sleeve"], qty: "", img: withBasePath("/products/bottle-500ml-front.jpg") },
  { name: "Elite Six-Pack", subtitle: "6 × 500ml", tag: "Most Popular", tagColor: "#c9a84c", features: ["6 × 500ml bottles", "Branded carrier", "Gift packaging"], qty: "×6", featured: true, img: withBasePath("/products/bottle-500ml-detail.jpg") },
  { name: "Luxury Case", subtitle: "24 × 500ml · Collector's", tag: "Collector's", tagColor: "#7ec8e3", features: ["24 × 500ml bottles", "Numbered edition", "White-glove delivery"], qty: "×24", img: withBasePath("/products/bottle-19l.jpg") },
];
